        ...
        function setLocValFunction(obj)
            if obj.nImages == 1
                ...
                obj.locValString = @(dim1L, dim1, dim2L, dim2, val1, val2) sprintf('\\color[rgb]{%.2f,%.2f,%.2f}%s:%4d\n%s:%4d\n\\color[rgb]{%.2f,%.2f,%.2f}%s:%s\n\\color[rgb]{%.2f,%.2f,%.2f}%s:%s', ...
                    ...
                    obj.COLOR_m(1, :), ...
                    obj.valNames{1}, ...
                    [num2sci(val1, 'latex', 1) obj.p.Results.Unit{1}], ...
                    obj.COLOR_m(2, :), ...
                    obj.valNames{2}, ...
                    [num2sci(val2, 'latex', 1) obj.p.Results.Unit{2}]);
            end
        end
...
%             end
        ...
        function guiResize(obj, varargin)
            ...
            if obj.nImages == 2
                n = n + 1;
                position = obj.divPosition3(n);
                set(obj.hBtnHide(1),  'Position', position(1, :));
        ...
        function pos = divPosition(obj, N)
            if obj.nImages == 1
                pos = [obj.margin ...
                    obj.figurePos(4)-obj.margin-N*obj.height-(N-1)*obj.yPadding ...
        ...
        function pos = positionN(obj, h, n)
            ...
            yPos  = obj.figurePos(4)-obj.margin-h*obj.height-(h-1)*obj.yPadding;
